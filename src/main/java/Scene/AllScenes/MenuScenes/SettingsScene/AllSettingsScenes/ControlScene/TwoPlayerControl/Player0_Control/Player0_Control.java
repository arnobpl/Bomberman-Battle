package Scene.AllScenes.MenuScenes.SettingsScene.AllSettingsScenes.ControlScene.TwoPlayerControl.Player0_Control;
...
import Scene.AllScenes.MenuScenes.SettingsScene.AllSettingsScenes.ControlScene.TwoPlayerControl.Player0_Control.Component.*;
 ...
 * Scene for 1st player control
 */
public class Player0_Control extends Scene {
    ...
    public Player0_Control() {
        ...
        sceneForm = new Form(new TwoPlayerControl(), Strings.ControlSettings.Player0, totalMenuItems, arrowMinDistance, -1);
