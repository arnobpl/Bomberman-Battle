package Scene.AllScenes.MenuScenes.SettingsScene.AllSettingsScenes.ControlScene.SinglePlayerControl;
...
import Scene.AllScenes.MenuScenes.SettingsScene.AllSettingsScenes.ControlScene.SinglePlayerControl.Component.*;
import Scene.Scene;
 ...
 * This class contains the scene of control settings for online player.
 */
public class SinglePlayerControl extends Scene {
    ...
    public SinglePlayerControl() {
        ...
        sceneForm = new Form(new ControlScene(), Strings.ControlSettings.OneHumanPlayer, totalMenuItems, arrowMinDistance, -1);
