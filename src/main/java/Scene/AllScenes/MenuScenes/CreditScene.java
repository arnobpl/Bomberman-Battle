 ...
 * This class contains the credit scene.
 */
...
//    private static final int textInfoGradientBackgroundLeft = TextInfoForm.infoTextImageLeft - textInfoGradientBackgroundEnlargeLength;
    ...
    private static final String infoText = Initialized.CreditInfoFromFile;
    ...
    public CreditScene() {
        ...
        sceneForm = new TextInfoForm(new MainMenu(), Strings.MainMenu.Credit, infoText, infoTextFontColor, true);
        sceneForm.enableAutoScrolling();
